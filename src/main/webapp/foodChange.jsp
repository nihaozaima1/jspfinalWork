...
<body>
<div class="main">
    <% food temp = (food) session.getAttribute("changedFood");
    %>
    <h2>编号:<%=temp.getId()%></h2>
    <form action="foodChangeServlet" method="get" class="form">
        菜名: <input type="text" name="foodname" value=<%=temp.getName()%>><br>
        起源: <input type="text" name="origin" value=<%=temp.getOrigin()%>><br>
